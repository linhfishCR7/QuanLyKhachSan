<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/auth/Auth.Master" AutoEventWireup="true" CodeBehind="Logout.aspx.cs" Inherits="QuanLyKhachSan.Admin.auth.Logout" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentAuth" runat="server">
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-muted">Back to <a href="pages-login.html" class="text-muted font-weight-medium ml-1">Sign In</a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
