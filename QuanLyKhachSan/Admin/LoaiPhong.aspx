<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin_Layout.Master" AutoEventWireup="true" CodeBehind="LoaiPhong.aspx.cs" Inherits="QuanLyKhachSan.Admin.LoaiPhong" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentAdmin" runat="server">
                ...
                <asp:UpdatePanel ID="upCrudGrid" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="GridView1" runat="server" Width="100%" HorizontalAlign="Center" OnRowCommand="GridView1_RowCommand"
                            ...
                            DataKeyNames="LP_MA" CssClass="table table-striped table-responsive table-hover table-bordered" Style="border-collapse: collapse; border-spacing: 0; width: 100%;" DataSourceID="SqlDataSource1" AllowPaging="True" PageSize="20">
                            <Columns>
                                ...
                                <asp:BoundField DataField="LP_MA" HeaderText="ID" ReadOnly="True" SortExpression="LP_MA" />
                                <asp:BoundField DataField="LP_GIA" HeaderText="Price" SortExpression="LP_GIA" />
                                <asp:BoundField DataField="LP_SONGUOIMAX" HeaderText="Max Quanlity" SortExpression="LP_SONGUOIMAX" />
                            </Columns>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtLP_MA" runat="server" CssClass="form-control"></asp:TextBox>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtLP_GIA" runat="server" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="field-2" class="control-label">Max Quanlity: (*)</label>
                                            <asp:TextBox ID="txtLP_SONGUOIMAX" runat="server" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="modal-body p-4">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="field-1" class="control-label">ID: (*)</label>
                                            <asp:TextBox ID="txtLP_MA1" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtLP_GIA1" runat="server" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="field-2" class="control-label">Max Quanlity: (*)</label>
                                            <asp:TextBox ID="txtLP_SONGUOIMAX1" runat="server" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                ...
                SelectCommand="SELECT * FROM [LOAI_PHONG]"
                DeleteCommand="DELETE FROM [LOAI_PHONG] WHERE [LP_MA] = @LP_MA"
                InsertCommand="INSERT INTO [LOAI_PHONG] ([LP_MA], [LP_GIA], [LP_SONGUOIMAX]) VALUES (@LP_MA, @LP_GIA, @LP_SONGUOIMAX)"
                UpdateCommand="UPDATE [LOAI_PHONG] SET [LP_GIA] = @LP_GIA, [LP_SONGUOIMAX] = @LP_SONGUOIMAX WHERE [LP_MA] = @LP_MA">
                <DeleteParameters>
                    <asp:Parameter Name="LP_MA" Type="String" />
                </DeleteParameters>
                <InsertParameters>
                    <asp:Parameter Name="LP_MA" Type="String" />
                    <asp:Parameter Name="LP_GIA" Type="Int32" />
                    <asp:Parameter Name="LP_SONGUOIMAX" Type="Int32" />
                </InsertParameters>
                <UpdateParameters>
                    <asp:Parameter Name="LP_GIA" Type="Int32" />
                    <asp:Parameter Name="LP_SONGUOIMAX" Type="Int32" />
