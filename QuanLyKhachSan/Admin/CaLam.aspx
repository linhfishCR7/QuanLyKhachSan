<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin_Layout.Master" AutoEventWireup="true" CodeBehind="CaLam.aspx.cs" Inherits="QuanLyKhachSan.Admin.CaLam" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentAdmin" runat="server">
                ...
                <asp:UpdatePanel ID="upCrudGrid" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="GridView1" runat="server" Width="100%" HorizontalAlign="Center" OnRowCommand="GridView1_RowCommand"
                            ...
                            DataKeyNames="CL_MA" CssClass="table table-striped table-responsive table-hover table-bordered" Style="border-collapse: collapse; border-spacing: 0; width: 100%;" DataSourceID="SqlDataSource1" AllowPaging="true" PageSize="20">
                            <Columns>
                                ...
                                <asp:BoundField DataField="CL_MA" HeaderText="ID" ReadOnly="True" SortExpression="CL_MA" />
                                <asp:BoundField DataField="CL_HESOLUONG" HeaderText="Coefficients Salary" SortExpression="CL_HESOLUONG" />
                            </Columns>
                        ...
                        <ContentTemplate>
                            <div class="modal-body p-4">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtCL_MA" runat="server" CssClass="form-control"></asp:TextBox>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="field-2" class="control-label">Coefficients Salary: (*)</label>
                                            <asp:TextBox ID="txtCL_HESOLUONG" runat="server" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="modal-body p-4">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="field-1" class="control-label">ID: (*)</label>
                                            <asp:TextBox ID="txtCL_MA1" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="field-2" class="control-label">Coefficients Salary: (*)</label>
                                            <asp:TextBox ID="txtCL_HESOLUONG1" runat="server" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                ...
                SelectCommand="SELECT * FROM [CA_LAM]"
                DeleteCommand="DELETE FROM [CA_LAM] WHERE [CL_MA] = @CL_MA"
                InsertCommand="INSERT INTO [CA_LAM] ([CL_MA], [CL_HESOLUONG]) VALUES (@CL_MA, @CL_HESOLUONG)"
                UpdateCommand="UPDATE [CA_LAM] SET [CL_HESOLUONG] = @CL_HESOLUONG WHERE [CL_MA] = @CL_MA">
                <DeleteParameters>
                    <asp:Parameter Name="CL_MA" Type="String" />
                </DeleteParameters>
                <InsertParameters>
                    <asp:Parameter Name="CL_MA" Type="String" />
                    <asp:Parameter Name="CL_HESOLUONG" Type="Double" />
                </InsertParameters>
                <UpdateParameters>
                    <asp:Parameter Name="CL_HESOLUONG" Type="Double" />
                    <asp:Parameter Name="CL_MA" Type="String" />
