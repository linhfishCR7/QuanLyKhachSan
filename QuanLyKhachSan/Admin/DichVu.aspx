<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin_Layout.Master" AutoEventWireup="true" CodeBehind="DichVu.aspx.cs" Inherits="QuanLyKhachSan.Admin.DichVu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentAdmin" runat="server">
                ...
                <asp:UpdatePanel ID="upCrudGrid" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="GridView1" runat="server" Width="100%" HorizontalAlign="Center" OnRowCommand="GridView1_RowCommand"
                            ...
                            DataKeyNames="DV_MA" CssClass="table table-striped table-responsive table-hover table-bordered" Style="border-collapse: collapse; border-spacing: 0; width: 100%;" DataSourceID="SqlDataSource1" AllowPaging="True" PageSize="20">
                            <Columns>
                                ...
                                <asp:BoundField DataField="DV_MA" HeaderText="ID" ReadOnly="True" SortExpression="DV_MA" />
                                <asp:BoundField DataField="DV_TEN" HeaderText="Service Name" SortExpression="DV_TEN" />
                            </Columns>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtDV_MA" runat="server" CssClass="form-control"></asp:TextBox>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtDV_TEN" runat="server" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="modal-body p-4">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="field-1" class="control-label">ID: (*)</label>
                                            <asp:TextBox ID="txtDV_MA1" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="field-2" class="control-label">Service Name: (*)</label>
                                            <asp:TextBox ID="txtDV_TEN1" runat="server" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                ...
                SelectCommand="SELECT * FROM [DICH_VU]"
                DeleteCommand="DELETE FROM [DICH_VU] WHERE [DV_MA] = @DV_MA"
                InsertCommand="INSERT INTO [DICH_VU] ([DV_MA], [DV_TEN]) VALUES (@DV_MA, @DV_TEN)"
                UpdateCommand="UPDATE [DICH_VU] SET [DV_TEN] = @DV_TEN WHERE [DV_MA] = @DV_MA">
                <DeleteParameters>
                    <asp:Parameter Name="DV_MA" Type="String" />
                </DeleteParameters>
                <InsertParameters>
                    <asp:Parameter Name="DV_MA" Type="String" />
                    <asp:Parameter Name="DV_TEN" Type="String" />
                </InsertParameters>
                <UpdateParameters>
                    <asp:Parameter Name="DV_TEN" Type="String" />
                    <asp:Parameter Name="DV_MA" Type="String" />
