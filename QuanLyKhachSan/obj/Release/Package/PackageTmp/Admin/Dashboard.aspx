...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentAdmin" runat="server">
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource1" DataKeyNames="DDP_MA">
                    <ItemTemplate>
                        <div class="col-xl-3 col-md-6">
                            <div class="card-box">
                                ...
                                <div class="text-right">
                                    <h3 class="mb-1"><%# Eval("SoDonDatPhong") %></h3>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:QLKSConnection %>" SelectCommand="SELECT COUNT(DDP_MA) AS SoDonDatPhong, DDP_MA FROM DON_DAT_PHONG GROUP BY DDP_MA"></asp:SqlDataSource>
